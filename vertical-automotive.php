...
<div id="vertical" class="automotive">
  ...
  <div class="content main">
    ...
    <div class="result">
      <div class="wrap">
        <div class="slides">
          <div class="slide" style="background-image:url('<?php echo get_template_directory_uri() ?>/assets/img/result-placeholder.jpg');">
            <div class="main-content">
              <h2>From Suzuki to Ferrari, Mini to Winnebago, Evinrude to Harley-Davidson...</h2>
              <p>We have:</p>
              <p class="words">
            ...
            <div class="overlay">
              ...
              <p class="words">
                ...
                <span style="font-size:65px;">From Last Place to Second in Segment</span>
              </p>
            </div>
          </div>
        </div>

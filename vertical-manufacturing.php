...
<div id="vertical" class="manufacturing">
  ...
  <div class="hdrShape hdrShape--mfcr"></div>
  <div class="content main">
    ...
    <div class="resultsManu">
      <div class="resultsManuImg">
        <img src="<?php echo get_template_directory_uri() ?>/assets/img/tank.png" class="img" alt="Tank">
      </div>
      <div class="flxWrap flxWrap--resultsMan">
        <div class="flxBloc flxBloc--resManCont resManCont--top">
          <h2 class="hdln hdln--ResM">From tanker trailers to valves, port trucks to pumps, components to fire hose nozzles, we have:</h2>
          <p class="words txt txt--ResMwords">
        ...
        <div class="flxBloc flxBloc--resManBlank"></div>
      </div>
      <div class="flxWrap flxWrap--resultsMan">
        <div class="flxBloc flxBloc--resManBlank"></div>
        <div class="flxBloc flxBloc--resManCont resManCont--btm">
          <h2 class="hdln hdln--ResM hdln--resMbtm">Result:</h2>
          <p class="words txt txt--ResMwords">
            <span>Saving 35% in budget and increasing sales 15%.</span>
